    ...
    const closeModal = function() {
        ...
        htmlModal = document.querySelector('.tech__modal__window--html').style.display = 'none';
        cssModal = document.querySelector('.tech__modal__window--css').style.display = 'none';
        jsModal = document.querySelector('.tech__modal__window--javascript').style.display = 'none';
    }
    ...
    function openHTML() {
        openModal;
        htmlModal = document.querySelector('.tech__modal__window--html').style.display = 'flex'; 
        console.log('HTML opened');  
    }
    // css
    function openCSS() {
        openModal;
        cssModal = document.querySelector('.tech__modal__window--css').style.display = 'flex';
        console.log('CSS opened');
    }
    // javascript
    function openJS() {
        openModal;
        jsModal = document.querySelector('.tech__modal__window--javascript').style.display = 'flex';
